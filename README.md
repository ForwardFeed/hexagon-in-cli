...
block.text[2] = hexagon_in_cli::text::format_string("please WORRY it's NOT trimed automatically this way, you have to care for it with that format_string function, or do it yourself".to_string(), 7);
